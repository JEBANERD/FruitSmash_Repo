...
local SOUND_DEFINITIONS: { [string]: SoundDefinition } = {
	swing = {
		SoundId = "rbxassetid://101467914599270",
		Volume = 0.55,
		PlaybackSpeed = 1.05,
	...
	hit = {
		SoundId = "rbxassetid://85072663979542",
		Volume = 0.8,
		PlaybackSpeed = 1,
		RollOffMode = Enum.RollOffMode.Inverse,
	...
	spawn = {
		SoundId = "rbxassetid://18989542559",
		Volume = 0.7,
		PlaybackSpeed = 1,
	},
	shield_on = {
		SoundId = "rbxassetid://2423389966",
		Volume = 0.65,
		PlaybackSpeed = 1,
