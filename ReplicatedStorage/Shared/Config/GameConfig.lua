...
-- Edit values here to tune the game. Everything else should read from this file only.
...
C.Player = {
    ...
    Sprint = {
        ...
        Stamina = {
            Enabled = true,
            DrainPerSecond = 18, -- [ASSUMED] units (abstract), no UI
            RegenPerSecond = 12,
        }
    },
...
C.Melee = {
    ...
    BaseDamage = 25, -- used for baseline melee, weapon modifiers may add
...
sed -n '1,200p' ReplicatedStorage/Shared/Config/GameConfig.lua
